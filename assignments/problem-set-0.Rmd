...
The first problem set in this course is designed to ensure you have managed to successfully install the tools we'll be using throughout the semester. After following the instructions for installing [R](https://cloud.r-project.org/), [RStudio](https://www.rstudio.com/products/rstudio/), and [Rtools](https://cran.r-project.org/bin/windows/Rtools/rtools42/rtools.html) (Windows) or [Xcode](https://apps.apple.com/us/app/xcode/id497799835?mt=12) (OSX) under the "Getting Started with R" module on the course's Canvas page, you should be able to open and compile this document in RStudio by clicking the **Knit** button. You'll be prompted to save the file to your computer so name it something like `lastname-firstname-problemset-0.Rmd` where `lastname` and `firstname` are your own last and first name respectively.

If everything is successfully configured, there should be a file called `lastname-firstname-problemset-0.html` in the same directory where you saved the first file to. **This is the file you need to Submit to Canvas via the "Problem Set 0: Getting Started with R and Markdown" assignment link, not the original .Rmd markdown file**. The due date for problem set 0 is Sunday, September 4th, 2022 at 11:59 PM.
