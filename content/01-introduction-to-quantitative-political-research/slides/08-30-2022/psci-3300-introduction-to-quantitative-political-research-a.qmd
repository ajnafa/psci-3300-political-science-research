...
-   Instructor: A. Jordan Nafa
    ...
    -   Bachelor of Science in Government and Computer Science, Texas Woman's University (2014-2018)
...
-   I assume you can add, subtract, multiply, and divide--I am sure some of you will prove me wrong
...
-   This course is taught from a primarily Bayesian perspective but we'll cover some frequentist estimation approaches as well
:::
...
```{r}
    ...
    tibble::tribble(
      ...
      "0", "Getting Started with R and Markdown", "September 4th",
      ...
      "4", "Regression for Causal Inference", "November 20th"
    ) |>
...
-   First problem set due September 4th to verify you have successfully completed these installations
:::
