...
::: a
Finally, to view the documentation for a specific function from a package you can type the syntax `?package::function` into the RStudio console where `package` is the name of the package and `function` is the name of the function.
:::
