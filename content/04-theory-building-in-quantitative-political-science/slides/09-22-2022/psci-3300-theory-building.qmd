...
::: incremental
-  We use nodes to represent concepts and their operationalizations, which we'll call variables

-  Causal relationships are comprised of concepts that influence one another

-  We can represent dependencies between concepts in the form of a network structure

-  If the validity of our conclusions rests fundamentally on our assumptions about the data generation process, we ought to explicit about those assumptions
:::
